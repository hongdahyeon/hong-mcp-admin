...
import { User, ChevronDown, LogOut, Settings, UserCircle, LogIn, UserPlus, Sun, Moon, Heart, ShoppingCart, Trash2, ArrowRight, LayoutDashboard, CalendarCheck, CreditCard, Ticket } from 'lucide-react';
